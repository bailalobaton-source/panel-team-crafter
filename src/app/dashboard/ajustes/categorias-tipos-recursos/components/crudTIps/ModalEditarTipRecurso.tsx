...
import { updateTiposRecurso } from "@/src/service/ajustes/categoriaTiposRecurso.service";
...
export default function ModalEditarTipRecurso({
  open,
  onClose,
  gfindTips,
  selectedTip,
  ...
  const onSubmit = async (data: TipClase) => {
    try {
      ...
      await updateTiposRecurso(data, selectedTip.id); // <-- ahora se envía como multipart/form-data
