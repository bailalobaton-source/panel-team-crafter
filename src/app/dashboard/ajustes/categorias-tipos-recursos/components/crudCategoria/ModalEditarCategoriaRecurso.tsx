...
import { updateCategoriaRecurso } from "@/src/service/ajustes/categoriaTiposRecurso.service";
...
export default function ModalEditarCategoriaRecurso({
  open,
  onClose,
  gfindCategorias,
  selectedCategoria,
  ...
  const onSubmit = async (data: CategoriaClase) => {
    try {
      ...
      await updateCategoriaRecurso(data, selectedCategoria.id); // <-- ahora se envía como multipart/form-data

      toast.success("La categoria se edito correctamente");
      reset();
      gfindCategorias();
      onClose();
    } catch (err) {
            ...
            <ModalBody>
              ...
              >
                <Input
                  ...
                  radius="sm"
                  size="sm"
                  defaultValue={selectedCategoria.nombre_es}
                />
                <Input
                  isRequired
                  classNames={inputClassNames}
                  ...
                  radius="sm"
                  size="sm"
                  defaultValue={selectedCategoria.nombre_en}
                />
