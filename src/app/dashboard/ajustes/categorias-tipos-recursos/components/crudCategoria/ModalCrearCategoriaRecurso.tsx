...
import { postCategoriaRecurso } from "@/src/service/ajustes/categoriaTiposRecurso.service";
...
export default function ModalCrearCategoriaRecurso({
  open,
  onClose,
  gfindCategorias,
}: Props) {
  ...
  const onSubmit = async (data: CategoriaClase) => {
    try {
      ...
      await postCategoriaRecurso(data); // <-- ahora se envía como multipart/form-data
