...
import { updateCategoriaClase } from "@/src/service/ajustes/categoriaTipClase.service";
...
export default function ModalEditarCategoriaClase({
  open,
  onClose,
  gfindCategorias,
  selectedCategoria,
  ...
  const onSubmit = async (data: CategoriaClase) => {
    try {
      ...
      await updateCategoriaClase(data, selectedCategoria.id); // <-- ahora se envía como multipart/form-data
