...
export default function ModalEditarClase({
  ...
  const onSubmit = async (data: FormClase) => {
    try {
      ...
      await updateClase(data, selectedClase.id); // <-- ahora se envía como multipart/form-data
        ...
        {(onClose) => (
          <>
            <ModalHeader className="pb-0">
              Editar Clase {selectedClase.titulo_clase}
            </ModalHeader>
            <ModalBody>
              <form
              ...
              >
                ...
                <Input
                  ...
                  radius="sm"
                  size="sm"
                  defaultValue={selectedClase.video_clase}
                />
                <Input
                  isRequired
                  classNames={inputClassNames}
                  ...
                  radius="sm"
                  size="sm"
                  defaultValue={selectedClase.poster_url}
                />
                <Input
                  isRequired
                  classNames={inputClassNames}
